...
const OpportunityDetails = () => {
  ...
  const fetchData = async () => {
    const res = await axios.get(
      `http://localhost:5000/api/partners/opportunities/opportunity/${opportunityID}`
    );
  ...
  return (
    <div className="flex items-center justify-center mt-32">
      <div class="flex flex-col w-3/5 md:w-4/5  rounded-lg bg-white shadow-lg  md:flex-row">
        <img
          class="h-96 md:w-3/6 rounded-t-lg  md:rounded-none md:rounded-l-lg"
