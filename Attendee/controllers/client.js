...
const { AttendeeStatus } = require('../models/AttendeeStatus');
...
const getDataFinalists = async (req, res) => {
  try {
...
const createDataFinalist = async (req, res) => {
  try {
...
const updateDataFinalist = async (req, res) => {
  const { id } = req.params;
...
const deleteDataFinalist = async (req, res) => {
  const { id } = req.params;
...
const createAttendeeStatus = async (req, res) => {
  const {
    name,
    email,
    city,
...
const deleteAttendeeStatus = async (req, res) => {
  const { id } = req.params;
...
const getAllAttendeeStatuses = async (req, res) => {
  try {
    const attendeeStatuses = await AttendeeStatus.find().populate('attendeeId');
    // const response = {};
...
//  const getAttendeeStatusById = async (req, res) => {
//   const { id } = req.params;
...
// const getEventSpcificAttendees = async (req, res) => {
//   const { event } = req.params;

//   try {
//     const attendees = await Attendee.find({ event: event });
